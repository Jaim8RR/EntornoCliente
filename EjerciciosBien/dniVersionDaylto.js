...
class DNI {
    ...
    verificarNumeros() {//verifica que la entrada tenga entre 1 y 8 números , da igual si hay letras antes después o entre.
    ...
    verificarLetra() { //Cogemos la ultima letra de la entrada.
        let er = /[a-zA-Z]$/; 
